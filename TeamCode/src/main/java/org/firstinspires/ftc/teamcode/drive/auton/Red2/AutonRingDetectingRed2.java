...
public class AutonRingDetectingRed2 extends LinearOpMode {
        ...
        switch (HowManyRings) {
            case FourRings:
                Trajectory traj1_4 = drive.trajectoryBuilder(startPose)
                        ...
                        .lineToLinearHeading(new Pose2d(0, -10, Math.toRadians(30)))
                ...
                Trajectory traj2_4 = drive.trajectoryBuilder(traj1_4.end())
                        ...
                        .lineToLinearHeading(new Pose2d(40,-10, Math.toRadians(160)))
                        .build();
                ...
                Trajectory traj4_4 = drive.trajectoryBuilder(traj3_4.end())
                        .lineToLinearHeading(new Pose2d(10, 5, Math.toRadians(0)))
                        .build();
    ...
    public abstract static class RingDetecting extends LinearOpMode {
        ...
        public static class RingDetection extends OpenCvPipeline {
            ...
            private final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(0, 750);
